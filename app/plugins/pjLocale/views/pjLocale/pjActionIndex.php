...
<fieldset class="fieldset white">
	...
	<form id="frmUpdateShowID" action="<?php echo PJ_INSTALL_URL; ?>admin.php?controller=pjLocale&amp;action=pjActionIndex" method="post" class="form pj-form b5">
...
<br/>
<form action="<?php echo PJ_INSTALL_URL; ?>admin.php" method="get" class="float_left pj-form frm-filter b5">
...
<form action="<?php echo PJ_INSTALL_URL; ?>admin.php?controller=pjLocale&amp;action=pjActionSaveFields" method="post" class="pj-form">

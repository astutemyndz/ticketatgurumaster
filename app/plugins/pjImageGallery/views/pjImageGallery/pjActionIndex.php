...
<fieldset class="fieldset white">
	...
	<form id="frmUpdateShowID" action="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjImageGallery&amp;action=pjActionIndex" method="post" class="form pj-form b5">
...
<form action="<?php echo PJ_INSTALL_URL; ?>index.php" method="get" class="float_left pj-form frm-filter b5">
	<input type="hidden" name="controller" value="pjImageGallery" />
...
<form action="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjImageGallery&amp;action=pjActionSaveFields" method="post" class="pj-form">

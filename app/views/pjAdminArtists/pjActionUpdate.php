...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminArtists&amp;action=pjActionIndex"><?php __('menuArtist'); ?></a></li>
		</ul>
	</div>
	
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminArtists&amp;action=pjActionUpdate" method="post" id="frmUpdateArtist" class="pj-form form" enctype="multipart/form-data">
		...
		<?php
			...
			<p>
				...
				<span class="inline_block">
					<input type="file" name="artist_image" id="artist_image" class="pj-form-field w300" />
				</span>
			</p>
			<?php
			if(!empty($tpl['arr']['artist_image']))
			{
				$image_url = PJ_INSTALL_URL . $tpl['arr']['artist_image'];
				?>
				<p id="image_container">
					<label class="title">&nbsp;</label>
					<span class="inline_block">
						<img class="td-image" src="<?php echo $image_url; ?>" style="width:263px"/>
						<!-- <a href="javascript:void(0);" class="pj-delete-image" data-href="<?php //echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminArtists&amp;action=pjActionDeleteImage&id=<?php //echo $tpl['arr']['id'];?>"><?php //__('btnDelete');?></a> -->
					</span>
				</p>
				<?php
			} 
		...
		<p>
			...
			<input type="button" value="<?php __('btnCancel'); ?>" class="pj-button" onclick="window.location.href='<?php echo PJ_INSTALL_URL; ?>admin.php?controller=pjAdminArtists&action=pjActionIndex';" />
		</p>
	</form>

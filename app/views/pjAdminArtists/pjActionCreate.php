...
if (isset($tpl['status']))
{
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminArtists&amp;action=pjActionCreate" method="post" id="frmCreateArtist" class="pj-form form" enctype="multipart/form-data">
		...
		<?php
			...
			<p>
				...
				<span class="inline_block">
					<input type="file" name="artist_image" id="artist_image" class="pj-form-field w300 required" />
				</span>
			</p>

...
if (isset($tpl['status']))
{
	...
	<div class="ui-tabs ui-widget ui-widget-content ui-corner-all b10">
		<ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active"><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminCustomerRequest&amp;action=pjActionIndex"><?php __('menuCustomerRequest'); ?></a></li>
		</ul>
	</div>
	<?php
	pjUtil::printNotice(__('infoCustomerRequestTitle', true, false), __('infoCustomerRequestDesc', true, false)); 
	?>
	<div class="b10">
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" class="float_left r5">
			<input type="hidden" name="controller" value="pjAdminCustomerRequest" />
	...
	var myLabel = myLabel || {};
	myLabel.customerName = "<?php __('customerName', false, true); ?>";
	myLabel.artistName = "<?php __('artistName', false, true); ?>";
	myLabel.customerRequestedSong = "<?php __('customerRequestedSong', false, true); ?>";
	myLabel.createdAt = "<?php __('createdAt', false, true); ?>";

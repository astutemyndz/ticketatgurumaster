...
if (isset($tpl['status']))
{
	...
	<input type="button" value="<?php __('btnBack'); ?>" class="pj-button" onclick="window.location.href='<?php echo PJ_INSTALL_URL; ?>admin.php?controller=pjAdminBookings&action=pjActionUpdate&id=<?php echo $_GET['id'];?>';" />

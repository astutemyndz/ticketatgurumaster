...
if (isset($tpl['status']))
{
	...
	<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminVideo&amp;action=pjActionCreate" method="post" id="frmCreateVideo" class="pj-form form" enctype="multipart/form-data">
		<input type="hidden" name="image_video_create" value="1" />
		<input type="hidden" id="index_arr" name="index_arr" value="" />
		<input type="hidden" id="remove_arr" name="remove_arr" value="" />
		<?php
		pjUtil::printNotice(__('infoAddVideo', true), __('infoAddVideoDesc', true)); 
		?>
		...
		<?php
			...
			<p>
				...
				<span class="inline_block">
					<input type="file" name="video_path" id="video_path" class="pj-form-field w300 required" />
				</span>
			</p>

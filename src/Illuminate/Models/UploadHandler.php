...
class UploadHandler
{
    ...
    protected function initialize() {
        switch ($this->get_server_var('REQUEST_METHOD')) {
            ...
            case 'HEAD':
                ...
                break;
            case 'GET':
                $this->response = $this->get($this->options['print_response']);
                break;
            case 'PATCH':
            case 'PUT':
            case 'POST':
                $this->response =  $this->post($this->options['print_response']);
                break;
            case 'DELETE':
                $this->response = $this->delete($this->options['print_response']);
                break;
            default:
    ...
    public function post($print_response = true) {
        ...
        if ($upload) {
            ...
            $this->response = array($this->options['param_name'] => []);
        }
